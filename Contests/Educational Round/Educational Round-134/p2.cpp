/*
    ...
    Problem link:       https://codeforces.com/contest/1721/problem/B
    Contest:            Educational Codeforces Round 134 (Rated for Div. 2)
    Date:               27/08/2022
...
void solve()
{
    ll n,m,a,b,d;
    cin>>n>>m>>a>>b>>d;
    if(a-1 > d && m-b > d) cout<<n+m-2<<ee;
    else if(n-a > d && b-1 > d) cout<<n+m-2<<ee;
    else cout<<-1<<ee;
}
